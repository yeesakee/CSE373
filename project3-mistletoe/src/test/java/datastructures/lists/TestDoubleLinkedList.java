...
public class TestDoubleLinkedList extends BaseTest {
    ...
    // tests we wrote for DoubleLinkedListDelete
    @Test
    void testDeleteEdge() {
        IList<Integer> list = new DoubleLinkedList<>();
        list.add(1);
    ...
    void nextNodeFront() {
        ...
        list.add(2);
        list.delete(0);
        DoubleLinkedList.Node<Integer> front = ((DoubleLinkedList<Integer>) list).front;
        DoubleLinkedList.Node<Integer> back = ((DoubleLinkedList<Integer>) list).back;
